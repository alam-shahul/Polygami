...
THREE.Geometry.prototype = {
    ...
    computeNormals: function(m) {
        ...
        for (o = 0,
        g = this.vertices.length; o < g; o++) {
            i = this.vertices[o];
            i.normal.set(0, 0, 0)
        }
        for (j = 0,
        l = this.faces.length; j < l; j++) {
            k = this.faces[j];
            if (m && k.vertexNormals.length) {
                h.set(0, 0, 0);
                for (e = 0,
                b = k.normal.length; e < b; e++) {
    ...
    createModel: function(b, d, a) {
        var c = function(f) {
            ...
            function i() {
                ...
                for (x = 0,
                u = b.triangles_n.length / 7; x < u; x++) {
                    D = b.triangles_n[x * 7];
...
THREE.Mesh.prototype.sortFacesByMaterial = function() {
    ...
    for (e = 0,
    m = this.geometry.faces.length; e < m; e++) {
...
THREE.Mesh.prototype.normalizeUVs = function() {
    var e, a, b, d, c;
    for (e = 0,
    a = this.geometry.uvs.length; e < a; e++) {
...
THREE.MeshColorFillMaterial = function(b, a, s) {
    this.color = new THREE.Color((a !== undefined ? a : 1) * 255 << 24 ^ b);
    if (s === undefined) {
      this.strokecolor = this.color;
    } else {
      this.strokecolor = new THREE.Color((a !== undefined ? a : 1) * 255 << 24 ^ s);
    }
    this.lineWidth = 1;
    this.toString = function() {
        return "THREE.MeshColorFillMaterial ( color: " + this.color + " lineWidth: " + this.lineWidth + ", strokecolor: " + this.strokecolor + " )"
    }
}
;
